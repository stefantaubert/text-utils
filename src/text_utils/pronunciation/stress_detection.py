...
from text_utils.pronunciation.ipa_symbols import (APPENDIX, ENG_ARPA_DIPHTONGS,
                                                  ENG_DIPHTHONGS, SCHWAS)
...
from text_utils.pronunciation.ipa_symbols import VOWELS as IPA_VOWELS
